...
print("코스닥 종목코드 압축 실행중... 약 1분30초~ 3분30초 가량이 소요됩니다.")

code_df = DataFrame(columns=("ItemName","Code"))

excel_1 = win32com.client.Dispatch("Excel.Application")
excel_1.Visible = False
wb = excel_1.Workbooks.Open('C:\\Users\\DG\\PycharmProjects\\Stock(ver.1)\\kosdaq.xls')
ws = wb.ActiveSheet
...
wb.SaveAs('C:\\Users\\DG\\PycharmProjects\\Stock\\zipKosdaq.xls')
excel_2.Quit()
print("종목 압축이 완료되었습니다.")